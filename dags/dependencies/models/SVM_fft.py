...
def main():
    ...
    # %% Training dataset
    normal_training = pd.read_csv(path+'normal_training_region3fft.csv')
    mass_training = pd.read_csv(path+'mass_2_training_region3fft.csv')
    aerodynamic_training = pd.read_csv(path+'aerodynamic_2_training_region3fft.csv')
    erosion_training = pd.read_csv(path+'erosion_2_training_region3fft.csv')
    ...
    # %% Test dataset
    normal_testing = pd.read_csv(path+'normal_testing_region3fft.csv')
    mass_testing = pd.read_csv(path+'mass_2_testing_region3fft.csv')
    aerodynamic_testing = pd.read_csv(path+'aerodynamic_2_testing_region3fft.csv')
    erosion_testing = pd.read_csv(path+'erosion_2_testing_region3fft.csv')
    ...
    ax.set_title("SVM classification - FFT data", fontsize=30)
    ...
    plt.savefig("SVM_fft.png", dpi=800)
